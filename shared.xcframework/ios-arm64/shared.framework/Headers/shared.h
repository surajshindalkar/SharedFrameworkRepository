...
@interface SharedConfigTable : SharedBase
- (instancetype)initWithKey:(NSString *)key value_:(SharedConfigModel *)value_ __attribute__((swift_name("init(key:value_:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedConfigModel *)component2 __attribute__((swift_name("component2()")));
- (SharedConfigTable *)doCopyKey:(NSString *)key value_:(SharedConfigModel *)value_ __attribute__((swift_name("doCopy(key:value_:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *key __attribute__((swift_name("key")));
@property (readonly) SharedConfigModel *value_ __attribute__((swift_name("value_")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConfigTable.Adapter")))
@interface SharedConfigTableAdapter : SharedBase
- (instancetype)initWithValue_Adapter:(id<SharedRuntimeColumnAdapter>)value_Adapter __attribute__((swift_name("init(value_Adapter:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id<SharedRuntimeColumnAdapter> value_Adapter __attribute__((swift_name("value_Adapter")));
@end;
...
@protocol SharedConfigTableQueries <SharedRuntimeTransacter>
@required
- (SharedRuntimeQuery<SharedConfigTable *> *)getKey:(NSString *)key __attribute__((swift_name("get(key:)")));
- (SharedRuntimeQuery<id> *)getKey:(NSString *)key mapper:(id (^)(NSString *, SharedConfigModel *))mapper __attribute__((swift_name("get(key:mapper:)")));
- (void)insertKey:(NSString *)key value_:(SharedConfigModel *)value_ __attribute__((swift_name("insert(key:value_:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EventTable")))
@interface SharedEventTable : SharedBase
- (instancetype)initWithId:(NSString *)id model:(SharedEventModel * _Nullable)model isDirty:(int64_t)isDirty timeStamp:(int64_t)timeStamp __attribute__((swift_name("init(id:model:isDirty:timeStamp:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedEventModel * _Nullable)component2 __attribute__((swift_name("component2()")));
- (int64_t)component3 __attribute__((swift_name("component3()")));
- (int64_t)component4 __attribute__((swift_name("component4()")));
- (SharedEventTable *)doCopyId:(NSString *)id model:(SharedEventModel * _Nullable)model isDirty:(int64_t)isDirty timeStamp:(int64_t)timeStamp __attribute__((swift_name("doCopy(id:model:isDirty:timeStamp:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) int64_t isDirty __attribute__((swift_name("isDirty")));
@property (readonly) SharedEventModel * _Nullable model __attribute__((swift_name("model")));
@property (readonly) int64_t timeStamp __attribute__((swift_name("timeStamp")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EventTable.Adapter")))
@interface SharedEventTableAdapter : SharedBase
- (instancetype)initWithModelAdapter:(id<SharedRuntimeColumnAdapter>)modelAdapter __attribute__((swift_name("init(modelAdapter:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id<SharedRuntimeColumnAdapter> modelAdapter __attribute__((swift_name("modelAdapter")));
@end;

__attribute__((swift_name("EventTableQueries")))
@protocol SharedEventTableQueries <SharedRuntimeTransacter>
@required
- (void)deleteId:(id)id __attribute__((swift_name("delete(id:)")));
- (SharedRuntimeQuery<SharedEventTable *> *)getTrackedEventsIsDirty:(int64_t)isDirty limit:(int64_t)limit __attribute__((swift_name("getTrackedEvents(isDirty:limit:)")));
- (SharedRuntimeQuery<id> *)getTrackedEventsIsDirty:(int64_t)isDirty limit:(int64_t)limit mapper:(id (^)(NSString *, SharedEventModel * _Nullable, SharedLong *, SharedLong *))mapper __attribute__((swift_name("getTrackedEvents(isDirty:limit:mapper:)")));
- (void)trackId:(NSString *)id model:(SharedEventModel * _Nullable)model isDirty:(int64_t)isDirty timeStamp:(int64_t)timeStamp __attribute__((swift_name("track(id:model:isDirty:timeStamp:)")));
@end;
...
@interface SharedIOSSSApi : SharedBase
@property (class, readonly, getter=companion) SharedIOSSSApiCompanion *companion __attribute__((swift_name("companion")));
- (void)flush __attribute__((swift_name("flush()")));
- (SharedSSUserApi *)getUser __attribute__((swift_name("getUser()")));
...
@interface SharedIOSSSApiCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedIOSSSApiCompanion *shared __attribute__((swift_name("shared")));
- (void)enableLogging __attribute__((swift_name("enableLogging()")));
- (SharedIOSSSApi *)getInstanceApiKey:(NSString *)apiKey apiSecret:(NSString *)apiSecret apiBaseUrl:(NSString * _Nullable)apiBaseUrl mutationHandler:(id<SharedMutationHandler>)mutationHandler __attribute__((swift_name("getInstance(apiKey:apiSecret:apiBaseUrl:mutationHandler:)")));
- (SharedIOSSSApi * _Nullable)getInstanceFromCachedApiKeyMutationHandler:(id<SharedMutationHandler>)mutationHandler __attribute__((swift_name("getInstanceFromCachedApiKey(mutationHandler:)")));
- (void)initialize __attribute__((swift_name("initialize()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Information")))
@interface SharedInformation : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
@protocol SharedMutationHandler
@required
...
@interface SharedSSUserApi : SharedBase
- (instancetype)initWithMutationHandler:(id<SharedMutationHandler>)mutationHandler __attribute__((swift_name("init(mutationHandler:)"))) __attribute__((objc_designated_initializer));
...
@protocol SharedSuprSendDatabase <SharedRuntimeTransacter>
@required
@property (readonly) id<SharedConfigTableQueries> configTableQueries __attribute__((swift_name("configTableQueries")));
@property (readonly) id<SharedEventTableQueries> eventTableQueries __attribute__((swift_name("eventTableQueries")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SuprSendDatabaseCompanion")))
@interface SharedSuprSendDatabaseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSuprSendDatabaseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedSuprSendDatabase>)invokeDriver:(id<SharedRuntimeSqlDriver>)driver ConfigTableAdapter:(SharedConfigTableAdapter *)ConfigTableAdapter EventTableAdapter:(SharedEventTableAdapter *)EventTableAdapter __attribute__((swift_name("invoke(driver:ConfigTableAdapter:EventTableAdapter:)")));
...
@interface SharedConfigModel : SharedBase
- (instancetype)initWithValue:(NSString *)value __attribute__((swift_name("init(value:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedConfigModelCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedConfigModel *)doCopyValue:(NSString *)value __attribute__((swift_name("doCopy(value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedConfigModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedConfigModelCompanion *shared __attribute__((swift_name("shared")));
...
@property (class, readonly) SharedLogLevel *off __attribute__((swift_name("off")));
...
@interface SharedLoggerKMM : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)dTag:(NSString *)tag message:(NSString *)message __attribute__((swift_name("d(tag:message:)")));
- (void)dTag:(NSString *)tag message:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("d(tag:message:throwable:)")));
...
- (void)iTag:(NSString *)tag message:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("i(tag:message:throwable:)")));
- (void)vTag:(NSString *)tag message:(NSString *)message __attribute__((swift_name("v(tag:message:)")));
- (void)vTag:(NSString *)tag message:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("v(tag:message:throwable:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkType")))
@interface SharedNetworkType : SharedKotlinEnum<SharedNetworkType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SharedNetworkType *wifi __attribute__((swift_name("wifi")));
@property (class, readonly) SharedNetworkType *g2 __attribute__((swift_name("g2")));
@property (class, readonly) SharedNetworkType *g3 __attribute__((swift_name("g3")));
@property (class, readonly) SharedNetworkType *g4 __attribute__((swift_name("g4")));
@property (class, readonly) SharedNetworkType *g5 __attribute__((swift_name("g5")));
@property (class, readonly) SharedNetworkType *unknown __attribute__((swift_name("unknown")));
+ (SharedKotlinArray<SharedNetworkType *> *)values __attribute__((swift_name("values()")));
@property (readonly) NSString *readableName __attribute__((swift_name("readableName")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EventFlushHandler")))
@interface SharedEventFlushHandler : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)eventFlushHandler __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedEventFlushHandler *shared __attribute__((swift_name("shared")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)flushEventsWithCompletionHandler:(void (^)(SharedKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("flushEvents(completionHandler:)")));
@property (readonly) NSString *TAG __attribute__((swift_name("TAG")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EventModel")))
@interface SharedEventModel : SharedBase
- (instancetype)initWithValue:(SharedKotlinx_serialization_jsonJsonElement *)value id:(NSString *)id __attribute__((swift_name("init(value:id:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedEventModelCompanion *companion __attribute__((swift_name("companion")));
- (SharedKotlinx_serialization_jsonJsonElement *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SharedEventModel *)doCopyValue:(SharedKotlinx_serialization_jsonJsonElement *)value id:(NSString *)id __attribute__((swift_name("doCopy(value:id:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) SharedKotlinx_serialization_jsonJsonElement *value __attribute__((swift_name("value")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EventModel.Companion")))
@interface SharedEventModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedEventModelCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PayloadCreator")))
@interface SharedPayloadCreator : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)payloadCreator __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPayloadCreator *shared __attribute__((swift_name("shared")));
- (NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)buildIdentityEventPayloadIdentifiedId:(NSString *)identifiedId anonymousId:(NSString *)anonymousId apiKey:(NSString *)apiKey __attribute__((swift_name("buildIdentityEventPayload(identifiedId:anonymousId:apiKey:)")));
- (NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)buildTrackEventPayloadEventName:(NSString *)eventName distinctId:(NSString *)distinctId superProperties:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)superProperties defaultProperties:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)defaultProperties userProperties:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> * _Nullable)userProperties apiKey:(NSString *)apiKey __attribute__((swift_name("buildTrackEventPayload(eventName:distinctId:superProperties:defaultProperties:userProperties:apiKey:)")));
- (NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)buildUserOperatorPayloadDistinctId:(NSString *)distinctId setProperties:(SharedKotlinx_serialization_jsonJsonElement *)setProperties operator:(NSString *)operator_ apiKey:(NSString *)apiKey __attribute__((swift_name("buildUserOperatorPayload(distinctId:setProperties:operator:apiKey:)")));
@end;
...
@protocol SharedUserEventDataSourceContract
@required
- (void)deleteIds:(NSArray<NSString *> *)ids __attribute__((swift_name("delete(ids:)")));
- (NSArray<SharedEventModel *> *)getEventsLimit:(int64_t)limit isDirty:(BOOL)isDirty __attribute__((swift_name("getEvents(limit:isDirty:)")));
- (void)trackEventModel:(SharedEventModel *)eventModel isDirty:(BOOL)isDirty __attribute__((swift_name("track(eventModel:isDirty:)")));
@end;

__attribute__((swift_name("UserApiInternalContract")))
@protocol SharedUserApiInternalContract
@required
...
@interface SharedKotlinx_serialization_jsonJsonElement (Extensions)
- (SharedKotlinx_serialization_jsonJsonElement * _Nullable)addUpdateJsoObjectUpdateJsonObject:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)updateJsonObject __attribute__((swift_name("addUpdateJsoObject(updateJsonObject:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KotlinExtensionKt")))
@interface SharedKotlinExtensionKt : SharedBase
+ (NSString *)getRandomStringLength:(int32_t)length __attribute__((swift_name("getRandomString(length:)")));
+ (NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)addCreateNewJO:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)receiver key:(NSString *)key value:(id)value __attribute__((swift_name("addCreateNewJO(_:key:value:)")));
+ (NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)addUpdateJsoObject:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> * _Nullable)receiver updateJsonObject:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)updateJsonObject __attribute__((swift_name("addUpdateJsoObject(_:updateJsonObject:)")));
+ (SharedKotlinx_serialization_jsonJsonPrimitive * _Nullable)convertToJsonPrimitive:(id)receiver key:(NSString *)key __attribute__((swift_name("convertToJsonPrimitive(_:key:)")));
+ (BOOL)isInValidKey:(NSString *)receiver __attribute__((swift_name("isInValidKey(_:)")));
+ (NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)toJsonObject:(NSDictionary<NSString *, id> *)receiver __attribute__((swift_name("toJsonObject(_:)")));
+ (NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)toKotlinJsonObject:(NSString * _Nullable)receiver __attribute__((swift_name("toKotlinJsonObject(_:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DispatchersKt")))
@interface SharedDispatchersKt : SharedBase
+ (SharedKotlinx_coroutines_coreCoroutineDispatcher *)ioDispatcher __attribute__((swift_name("ioDispatcher()")));
+ (SharedKotlinx_coroutines_coreCoroutineDispatcher *)mainDispatcher __attribute__((swift_name("mainDispatcher()")));
+ (SharedKotlinx_coroutines_coreCoroutineDispatcher *)singleThreadDispatcher __attribute__((swift_name("singleThreadDispatcher()")));
@end;
